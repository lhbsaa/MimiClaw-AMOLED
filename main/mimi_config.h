...
/* MimiClaw-AMOLED Global Configuration */
...
#define MIMI_SECRET_OLLAMA_PORT     ""
#endif
#ifndef MIMI_SECRET_OLLAMA_MODEL
#define MIMI_SECRET_OLLAMA_MODEL    ""
#endif
...
#define MIMI_LLM_PROVIDER_DEFAULT    ""
#define MIMI_LLM_MAX_TOKENS          4096
#define MIMI_LLM_API_URL             "https://api.anthropic.com/v1/messages"
#define MIMI_OPENAI_API_URL          "https://api.openai.com/v1/chat/completions"
#define MIMI_OLLAMA_API_URL          "http://" MIMI_SECRET_OLLAMA_HOST ":" MIMI_SECRET_OLLAMA_PORT "/v1/chat/completions"
...
#define MIMI_CLI_PRIO                6
#define MIMI_CLI_CORE                1
...
#define MIMI_NVS_KEY_OLLAMA_MODEL    "ollama_model"
#define MIMI_NVS_KEY_API_URL         "api_url"      /* Custom API URL for 'custom' provider */
#define MIMI_NVS_KEY_API_HOST        "api_host"     /* Custom API host for TLS */

/* WiFi Onboarding (Captive Portal) */
#define MIMI_ONBOARD_AP_PREFIX    "MimiClaw-AMOLED-"
...
/* Battery ADC (GPIO4, voltage divider 2:1) */
#define BATTERY_ADC_PIN           4
#define MIMI_BATT_MV_EMPTY        3300    /* Battery empty voltage in mV */
#define MIMI_BATT_MV_FULL         4200    /* Battery full voltage in mV */
#define MIMI_BATT_MV_CHARGING     4250    /* Battery charging threshold in mV */
#define MIMI_BATT_DIVIDER_RATIO   2       /* Voltage divider ratio */
#define MIMI_BATT_UPDATE_MS       5000    /* Battery update interval in ms */
